...
class CNNBlock(nn.Module):
    def __init__(self, in_chan, nf, n_layers,maxpool,S,a,k):
        ...
        for i in range(self.nlayers):
            ...
            #torch.nn.init.xavier_uniform_(self.convs[i].weight.data, nn.init.calculate_gain('leaky_relu',self.a))
    ...
    def forward(self, x):
        ...
        for i in range(self.nlayers):
          ...
          x = x - dt * F.conv_transpose2d(self.nl((A(x))), A.weight, padding=1, stride=1)
